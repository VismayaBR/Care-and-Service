...
$edd=mysqli_query($conn,"SELECT * FROM reg_tb WHERE login_id='$details'");
...
if(isset($_POST['sub']))
{
  ...
  $pic=$_FILES['f1']['name'];
   ...
   if($pic !="")
      ...
      if(check_ext($file_ext))
      {
              ...
              mysqli_query($conn,"UPDATE reg_tb SET image='$filenew' WHERE login_id='$details'");
       } 
       else{
 ...
 $update=mysqli_query($conn,"UPDATE reg_tb SET name='$name', mobile='$mobile', email='$email', address='$address', district='$district', localbody='$localbody' WHERE login_id='$details'");
...
<option></option>
 ...
 -->
                                ...
                                <div class="form-group text-center">
                                    <a href=""><button type="submit"name="sub" id="sub"onclick="return valid()" value="">Update now</button></a>
                                </div>                            
                            </div>
                            </div>
                        </div>
