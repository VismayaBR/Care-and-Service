...
$lid=$_SESSION["login_id"];
  ...
  $var=mysqli_query($conn,"SELECT * FROM req_tb WHERE status='rejected' AND status='accepted'");
        ...
        <div class="col-md-8">
          <div class="tile">
            <h3 class="tile-title">Requests</h3>
                                    <a href="list.php" ><button type="submit"name="sub" id="sub"onclick="return valid()" value="">Confirmations</button></a> 
