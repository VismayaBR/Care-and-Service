...
if(isset($_POST['sub']))
{
 ...
 $select=mysqli_query($conn,"INSERT INTO `req_tb`(`log_id`,`name`,`phn_number`,`request`,`district`,`localbody`,`pal_log_id`) VALUES('$lid','$name','$phn_number','$request','$district','$localbody','0')");
                    ...
                    <form name="contact_form" class="default-form contact-form" method="post">
                        <div class="row">
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                ...
                                <div class="form-group">
                                    <input type="text" name="phn_number" id="phn_number" placeholder="phn_number" required="required"pattern="[0-9].{9}">
                                </div>

                                 <div class="form-group">
                                    <input type="text" name="request" id="request" placeholder="your_request" required="">
                                </div>
                                 <div class="form-group">     
                           ...
                           <!-- <div>
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="form-group text-center">
                                    <button type="submit"name="sub" id="sub"class="btn-style-one">request</button>
</div>
                                </div>                            
                            </div>
                            </div>
