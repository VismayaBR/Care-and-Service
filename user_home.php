            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                  <ul class="nav navbar-nav">
                       ...
                       <li><a href="profile.php"> profile</a></li>
                        ...
                        <li>
                              <a href="req.php">request</a>
                        </li>

                        
                        <li><a href="request_status.php">Request status</a></li>
                        <li><a href="donation_status.php">Donation status</a></li>
                        <li>
                              <a href="admin/ad_logout.php">Logout</a>
                        </li>
                  </ul>
            </div>
            <!-- /.navbar-collapse -->
...
Integrates the psychological and spiritual aspects of care</h2>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="content style text-center">
                        <h2 class="text-white text-bold mb-2">
there is an end to cure;there is no end to care</h2>
...
<section class="service-section bg-gray section">
    <div class="container">
        <div class="section-title text-center">
            <h3>Provided services
              <!--  <br> <span>Care and Services</span> -->
            </h3>
            ...
            <div class="item">
                <div class="inner-box">
                    <div class="img_holder">
                        <a href="service.php">
                           <img src="admin/images/<?php echo $data['image'];?>"width="100" height="100">
                        </a>
                    </div>
                    <div class="image-content text-center">
                       <!--  <span>Better Service At Low Cost</span> -->
                        <a href="service.php">
                            <h6><?php echo $data['service'];?></h6>
                        </a>
    ...
    <div class="container clearfix">
      <div class="copyright-text">
        <p>&copy; Copyright 2018.
          <a href="home.php">care and srvice</a>
        </p>
      </div>
